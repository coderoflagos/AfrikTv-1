...
<div class="col-sm-6" style="margin-top: 10%;">
    ...
    <div class="form-group row">
        <div class="col-sm-10">
            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus style="border-radius: 30px;" placeholder="{{ __('Name') }}">
 ...
 {{-- <div class="form-group row">
    ...
    <div class="form-group row">
        <div class="col-sm-10">
            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" style="border-radius: 30px; width: 100%;" placeholder="{{ __('Password') }}">
    ...
    <div class="form-group row">
        <div class="col-sm-10">
            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" style="border-radius: 30px; width: 100%;" placeholder="{{ __('Confirm Password') }}">
        </div>
    </div>
<br>
   ...
   <br>
    <button type="submit" class="btn btn-primary pull-right" style="border-radius: 20px; background-color: maroon; width: 82%; border-color: maroon;">{{ __('Sign Up') }}</button>
        </div>
    </div>
</form>
</div>
